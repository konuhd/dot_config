...
def write_gtk(palette):
    """Apply a compact, legible Morandi control style on top of the GTK theme."""
    marker = "/* MORANDI-CONTROLS-BEGIN */"
    end_marker = "/* MORANDI-CONTROLS-END */"
    block = f'''{marker}
/* Generated by morandi-gen.py — keep this block at the end of gtk.css */
checkbutton, radiobutton,
checkbutton:focus, radiobutton:focus,
checkbutton:checked, radiobutton:checked,
checkbutton:focus:checked, radiobutton:focus:checked {{
  background-color: transparent;
  background-image: none;
  box-shadow: none;
}}

check, radio, checkbutton > check, radiobutton > radio {{
  min-width: 18px;
  min-height: 18px;
  margin: -5px;
  padding: 5px;
  border: 1.5px solid {palette["overlay1"]};
  background-color: alpha({palette["surface1"]}, 0.72);
  color: {palette["text"]};
  background-image: none;
...
check:hover, radio:hover, checkbutton > check:hover, radiobutton > radio:hover {{
  border-color: {palette["iris"]};
  background-color: alpha({palette["iris"]}, 0.14);
}}

check:focus, radio:focus, checkbutton > check:focus, radiobutton > radio:focus {{
  border-color: {palette["iris"]};
  background-color: alpha({palette["surface1"]}, 0.72);
  background-image: none;
  box-shadow: 0 0 0 3px alpha({palette["iris"]}, 0.22);
}}

check:checked, check:indeterminate, checkbutton > check:checked, checkbutton > check:indeterminate {{
  border-color: {palette["iris"]};
...
radio:checked:not(:indeterminate), radiobutton > radio:checked:not(:indeterminate) {{
  border-color: {palette["iris"]};
  border-image: none;
  background-color: {palette["iris"]};
...
radio:indeterminate, radiobutton > radio:indeterminate {{
  border-color: {palette["iris"]};
  border-image: none;
...
check:disabled, radio:disabled, checkbutton > check:disabled, radiobutton > radio:disabled {{
  border-color: alpha({palette["overlay1"]}, 0.5);
  background-color: alpha({palette["surface1"]}, 0.4);
